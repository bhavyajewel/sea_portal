...
<head>
	...
	<!-- Style-CSS -->
	l<link rel="stylesheet" href="<?php echo base_url();?>user/css/fontawesome-all.css">
	...
	<link href="<?php echo base_url();?>user/fonts.googleapis.com/css?family=Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=latin-ext"
	    rel="stylesheet">
	<link href="<?php echo base_url();?>user/fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i,800,800i" rel="stylesheet">
	<!-- //Web-Fonts -->
...
<body>
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<a class="navbar-brand" href="index.html">
				<i class="fas fa-ship mr-2"></i>e SEA PORTAL</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto text-center mr-lg-5">
					<li class="nav-item active mr-lg-2 mb-lg-0 mb-2">
						<a class="nav-link" href="<?php echo base_url();?>Welcome/indexhome">Home
					...
					<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="<?php echo base_url();?>Welcome/companyreg">Company</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url();?>Welcome/contractreg">Contractor</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url();?>Welcome/userreg">User</a>
						</div>
					</li>
					</li>
					<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
						<a class="nav-link" href="<?php echo base_url();?>user/services.html">About Us</a>
					</li>
					<!-- <li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
						<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							pages
						...
						<div class="dropdown-menu">
							<a class="dropdown-item" href="<?php echo base_url();?>user/404.html">404</a>
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="<?php echo base_url();?>user/typo.html">Typography</a>
						</div> -->
					</li>
					<li class="nav-item mr-lg-2 mb-lg-0 mb-2">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="w3l-overlay">
						<div class="container">
							<div class="slider-text text-white p-lg-5 p-4">
								...
								<p>A sea portal is a type of intermodel transportation facility that allows cargo to be transferred between ships and other models of transportation, such as trucks or trains. It's essentially a hub for effecient cargo handling and transfer.</p>
							</div>
						</div>
						<div class="row carousel-caption">
							<div class="col-4 banner-bot">
								<i class="fas fa-globe mb-2"></i>
								<h5>World wide transport</h5>
							</div>
							<div class="col-4 banner-bot">
								<i class="fab fa-dropbox mb-2"></i>
								<h5>Safety</h5>
							</div>
							<div class="col-4 banner-bot">
			...
			<a class="carousel-control-prev" href="<?php echo base_url();?>user/#carouselExampleIndicators" role="button" data-slide="prev">
				<span class="carousel-control-prev-icon" aria-hidden="true"></span>
				<span class="sr-only">Previous</span>
			</a>
			<a class="carousel-control-next" href="<?php echo base_url();?>user/#carouselExampleIndicators" role="button" data-slide="next">
		...
		<div class="container-fluid">
			<div class="row wthree-services-bottom-grids py-xl-5 py-lg-3">
				<div class="col-lg-6 wthree-services-left img-2-w3  text-center">
					<img src="<?php echo base_url();?>user/images/logi.jpg" alt="" class="img-fluid">
				</div>
	...
	<div class="middle-w3l py-sm-5 py-4">
		<div class="container py-xl-5 py-lg-3">
			...
			<!-- <a href="<?php echo base_url();?>user/contact.html" class="btn btn-secondary btn-lg button2-w3l mt-4" role="button" aria-pressed="true">Contact Us</a> -->
		</div>
	</div>
	<!-- //middle section -->
		...
		<div class="container">
			<div class="row w3ls_footer_grid text-lg-left text-center pb-lg-5 pb-4 mt-xl-4 mt-1 mb-xl-5 mb-4">
				...
				<div class="col-lg-7 w3ls_footer_grid1_right text-lg-right text-center">
					<ul>
						<li class="mr-3">
							<a href="<?php echo base_url();?>user/index.html" class="active">Home</a>
						</li>
						<li class="mr-3">
							<a href="<?php echo base_url();?>user/about.html">Registration</a>
						</li>
						<li class="mr-3">
							<a href="<?php echo base_url();?>user/services.html">About Us</a>
						</li>
						<li class="mr-3">
							<a href="<?php echo base_url();?>user/gallery.html">Login</a>
						</li>
						<li>
							<a href="<?php echo base_url();?>user/contact.html">Log Out</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-3 col-6 w3ls_footer_grid_right">
					<h1>
						<a href="<?php echo base_url();?>user/index.html">
							<i class="fas fa-ship mr-2"></i>e SEA PORTAL</a>
					</h1>
				</div>
				...
				<div class="col-lg-6 w3ls_footer_grid1_left mt-lg-2 mt-4 text-lg-right text-center">
					<!-- <p>&copy; 2018 Transports. All rights reserved | Design by -->
						<!-- <a href="<?php echo base_url();?>user/http://w3layouts.com/">W3layouts</a> -->
					</p>
				</div>
			</div>
		</div>
	...
	<!-- smooth scrolling -->
	<script src="<?php echo base_url();?>user/js/SmoothScroll.min.js"></script>
	<!-- //smooth scrolling -->

	<!-- start-smoth-scrolling -->
	<script src="<?php echo base_url();?>user/js/move-top.js"></script>
	<script src="<?php echo base_url();?>user/js/easing.js"></script>
	<script>
