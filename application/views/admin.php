...
<head>
  ...
  <!-- overlayScrollbars -->
  <link rel="stylesheet" href="<?php echo base_url();?>admin/overlayScrollbars/css/OverlayScrollbars.min.css">
  <!-- Daterange picker -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url();?>admin/./index.html" class="nav-link active">
